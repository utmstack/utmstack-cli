...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const names = ["utmstack.json", "utmstack.jsonc", "opencode.json", "opencode.jsonc"]
    ...
    const discovered = locationIsGlobal
      ...
      : yield* fs
          .up({
            targets: [".utmstack", ".opencode", ...names.toReversed()],
    ...
    const directories = [
      globalDirectory,
      ...discovered
        .filter((item) => item.endsWith(".utmstack") || item.endsWith(".opencode"))
        .toReversed()
