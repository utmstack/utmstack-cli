...
**Save plans to:** `docs/opencode-skills/plans/YYYY-MM-DD-<feature-name>.md`
...
**"Plan complete and saved to `docs/opencode-skills/plans/<filename>.md`. Two execution options:**
